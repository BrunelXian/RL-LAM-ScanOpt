...
CSV_PATH = OUTPUT_DIR / "stage3_run55_calibrated_N24_N40_batch64_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run55_calibrated_N24_N40_batch64_generated_inp_check_summary.json"
CASE_ROOT = PROJECT_ROOT / "cae_model" / "stage3_run54_calibrated_N24_N40_batch64_v01"
...
def main() -> int:
    ...
    verdict = "PASS_RUN55_CALIBRATED_N24_N40_BATCH64_64_INPS_READY_FOR_USER_REVIEW" if len(results) == 64 and all(row["verdict"] == "PASS" for row in results) and inp_count == 64 and cae_count == 64 and solver_count == 0 and forbidden_inp_count == 0 else "FAIL_RUN55_CALIBRATED_N24_N40_BATCH64_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN55_CALIBRATED_N24_N40_BATCH64_64_INPS_READY_FOR_USER_REVIEW" else 1
