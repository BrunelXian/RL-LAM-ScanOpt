...
CSV_PATH = OUTPUT_DIR / "stage3_run40_native_N24_N40_focused_batch60_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run40_native_N24_N40_focused_batch60_generated_inp_check_summary.json"
CASE_ROOT = PROJECT_ROOT / "cae_model" / "stage3_run39_native_N24_N40_focused_batch60_v01"
...
def main() -> int:
    ...
    verdict = "PASS_RUN40_NATIVE_N24_N40_FOCUSED_BATCH60_60_INPS_READY_FOR_USER_REVIEW" if len(results) == 60 and all(row["verdict"] == "PASS" for row in results) and inp_count == 60 and cae_count == 60 and solver_count == 0 and forbidden_inp_count == 0 else "FAIL_RUN40_NATIVE_N24_N40_FOCUSED_BATCH60_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN40_NATIVE_N24_N40_FOCUSED_BATCH60_60_INPS_READY_FOR_USER_REVIEW" else 1
