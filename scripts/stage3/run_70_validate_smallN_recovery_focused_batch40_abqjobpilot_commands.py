...
COMMAND_FILE = OUTPUT_DIR / "stage3_run70_smallN_recovery_focused_batch40_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run70_smallN_recovery_focused_batch40_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run70_smallN_recovery_focused_batch40_abqjobpilot_command_validation_summary.json"
...
def validate_line(line: str, row: dict[str, str]) -> dict[str, object]:
    ...
    result: dict[str, object] = {
        ...
        "forbidden_batch_reference": "small-n" in line.lower() or "diagnostic" in line.lower(),
...
def main() -> int:
    ...
    verdict = "PASS_RUN70_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN70_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN70_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
