...
CSV_PATH = OUTPUT_DIR / "stage3_run45_constrained_N24_N40_batch32_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run45_constrained_N24_N40_batch32_generated_inp_check_summary.json"
CASE_ROOT = PROJECT_ROOT / "cae_model" / "stage3_run44_constrained_N24_N40_batch32_v01"
...
def main() -> int:
    ...
    verdict = "PASS_RUN45_CONSTRAINED_N24_N40_BATCH32_32_INPS_READY_FOR_USER_REVIEW" if len(results) == 32 and all(row["verdict"] == "PASS" for row in results) and inp_count == 32 and cae_count == 32 and solver_count == 0 and forbidden_inp_count == 0 else "FAIL_RUN45_CONSTRAINED_N24_N40_BATCH32_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN45_CONSTRAINED_N24_N40_BATCH32_32_INPS_READY_FOR_USER_REVIEW" else 1
