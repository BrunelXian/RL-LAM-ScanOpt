"""Audit generated Stage L PPO v02K2 CAE/INP files and write command file."""
...
CSV_OUT = OUTPUT_ROOT / "checks" / "stageL_generated_CAE_INP_audit.csv"
JSON_OUT = OUTPUT_ROOT / "checks" / "stageL_generated_CAE_INP_audit_summary.json"
COMMAND_FILE = OUTPUT_ROOT / "commands" / "stageL_v02K2_batch32_abqjobpilot_commands_READY_TO_RUN.txt"
...
def main() -> int:
    ...
    verdict = "PASS_STAGEL_V02K2_CAE_INP_READY_FOR_USER_CONTROLLED_SOLVER" if ok else "FAIL_STAGEL_V02K2_CAE_INP_GENERATION_FAILED"
    summary = {
        "verdict": verdict,
