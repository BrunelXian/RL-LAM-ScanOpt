...
CSV_PATH = OUTPUT_DIR / "stage3_run60_custom_N40_focused_batch40_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run60_custom_N40_focused_batch40_generated_inp_check_summary.json"
CASE_ROOT = PROJECT_ROOT / "cae_model" / "stage3_run59_N40_focused_calibrated_penalty_repair_batch40_v01"
...
def main() -> int:
    ...
    verdict = "PASS_RUN60_CUSTOM_N40_FOCUSED_BATCH40_40_INPS_READY_FOR_USER_REVIEW" if len(results) == 40 and all(row["verdict"] == "PASS" for row in results) and inp_count == 40 and cae_count == 40 and solver_count == 0 and forbidden_inp_count == 0 else "FAIL_RUN60_CUSTOM_N40_FOCUSED_BATCH40_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN60_CUSTOM_N40_FOCUSED_BATCH40_40_INPS_READY_FOR_USER_REVIEW" else 1
