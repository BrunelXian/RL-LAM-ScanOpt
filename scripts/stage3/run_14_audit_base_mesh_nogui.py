"""Abaqus noGUI base mesh audit for Stage 3 run14 batch20 generation."""
...
CSV_PATH = OUTPUT_DIR / "run14_base_mesh_audit.csv"
SUMMARY_PATH = OUTPUT_DIR / "run14_base_mesh_audit_summary.json"
...
def main() -> int:
    ...
    overall = (
        ...
        else "FAIL_RUN14_BASE_MESH_AUDIT_INVALID"
    )
    summary = {
        "verdict": overall,
        "rows": rows,
    ...
    return 0 if overall == "PASS_RUN14_BASE_MESH_AUDIT_READY" else 1
