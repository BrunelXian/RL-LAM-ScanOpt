...
| run_03 | Variable-N graph feature builder | Define and dry-check graph features for N variation. | TBD | TBD | TBD | planned | No candidate generation beyond placeholders. |
