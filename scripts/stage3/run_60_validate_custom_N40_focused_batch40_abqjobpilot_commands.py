...
COMMAND_FILE = OUTPUT_DIR / "stage3_run60_custom_N40_focused_batch40_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run60_custom_N40_focused_batch40_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run60_custom_N40_focused_batch40_abqjobpilot_command_validation_summary.json"
...
def validate_line(line: str, row: dict[str, str]) -> dict[str, object]:
    ...
    result: dict[str, object] = {
        ...
        "forbidden_batch_reference": "batch64" in line.lower() or "recovery" in line.lower() or "batch48" in line.lower(),
...
def main() -> int:
    ...
    errors = []
    if len(commands) != 40:
        errors.append("command count {} != 40".format(len(commands)))
    ...
    verdict = "PASS_RUN60_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN60_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN60_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
