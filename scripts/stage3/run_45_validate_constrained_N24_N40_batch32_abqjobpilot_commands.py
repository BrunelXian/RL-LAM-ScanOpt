...
COMMAND_FILE = OUTPUT_DIR / "stage3_run45_constrained_N24_N40_batch32_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run45_constrained_N24_N40_batch32_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run45_constrained_N24_N40_batch32_abqjobpilot_command_validation_summary.json"
...
def main() -> int:
    ...
    verdict = "PASS_RUN45_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN45_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN45_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
