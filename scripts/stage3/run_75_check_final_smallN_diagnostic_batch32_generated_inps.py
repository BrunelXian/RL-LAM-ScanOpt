"""Check Stage 3 run75 final_smallN_diagnostic_batch32 generated INP files."""
...
CSV_PATH = OUTPUT_DIR / "stage3_run75_final_smallN_diagnostic_batch32_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run75_final_smallN_diagnostic_batch32_generated_inp_check_summary.json"
CASE_ROOT = PROJECT_ROOT / "cae_model" / "stage3_run74_final_smallN_diagnostic_batch32_v01"
...
def main() -> int:
    ...
    verdict = "PASS_RUN75_FINAL_SMALLN_DIAGNOSTIC_BATCH32_32_INPS_READY_FOR_USER_REVIEW" if len(results) == 32 and all(row["verdict"] == "PASS" for row in results) and inp_count == 32 and cae_count == 32 and solver_count == 0 and forbidden_inp_count == 0 else "FAIL_RUN75_FINAL_SMALLN_DIAGNOSTIC_BATCH32_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN75_FINAL_SMALLN_DIAGNOSTIC_BATCH32_32_INPS_READY_FOR_USER_REVIEW" else 1
