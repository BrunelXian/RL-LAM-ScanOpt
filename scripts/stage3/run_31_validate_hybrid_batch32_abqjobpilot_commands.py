"""Create and validate run31 hybrid_batch32 abqjobpilot command file.
...
COMMAND_FILE = OUTPUT_DIR / "stage3_run31_hybrid_batch32_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run31_hybrid_batch32_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run31_hybrid_batch32_abqjobpilot_command_validation_summary.json"
...
def validate_line(line: str, row: dict[str, str]) -> dict[str, object]:
    ...
    checks = [
        ...
        not result["bad_schema"], not result["forbidden_batch_reference"],
    ]
...
def main() -> int:
    ...
    verdict = "PASS_RUN31_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN31_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN31_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
