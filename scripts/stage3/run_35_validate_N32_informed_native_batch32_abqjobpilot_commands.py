"""Create and validate run35 N32_informed_native_batch32 abqjobpilot command file.
...
COMMAND_FILE = OUTPUT_DIR / "stage3_run35_N32_informed_native_batch32_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run35_N32_informed_native_batch32_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run35_N32_informed_native_batch32_abqjobpilot_command_validation_summary.json"
...
def validate_line(line: str, row: dict[str, str]) -> dict[str, object]:
    ...
    result: dict[str, object] = {
        ...
        "forbidden_batch_reference": "batch64" in line.lower() or "batch48" in line.lower() or "shortlist64" in line.lower(),
        "has_n32_command": int(row["n"]) == 32 or case_folder.startswith("N32"),
        "verdict": "FAIL",
    }
    checks = [
        ...
        not result["bad_schema"], not result["forbidden_batch_reference"], not result["has_n32_command"],
    ]
...
def main() -> int:
    ...
    verdict = "PASS_RUN35_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN35_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN35_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
