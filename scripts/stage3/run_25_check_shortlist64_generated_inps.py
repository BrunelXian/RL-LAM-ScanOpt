"""Check Stage 3 run25 shortlist64 generated INP files."""
...
CSV_PATH = OUTPUT_DIR / "stage3_run25_shortlist64_generated_inp_check.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run25_shortlist64_generated_inp_check_summary.json"
...
def main() -> int:
    ...
    verdict = "PASS_RUN25_SHORTLIST64_64_INPS_READY_FOR_USER_REVIEW" if len(results) == 64 and all(row["verdict"] == "PASS" for row in results) and inp_count == 64 and cae_count == 64 and solver_count == 0 else "FAIL_RUN25_SHORTLIST64_INP_CHECK_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN25_SHORTLIST64_64_INPS_READY_FOR_USER_REVIEW" else 1
