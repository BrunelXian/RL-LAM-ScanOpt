...
COMMAND_FILE = OUTPUT_DIR / "stage3_run50_stricter_constrained_N24_N40_batch32_abqjobpilot_commands_READY_TO_RUN.txt"
CSV_PATH = OUTPUT_DIR / "stage3_run50_stricter_constrained_N24_N40_batch32_abqjobpilot_command_validation.csv"
SUMMARY_PATH = OUTPUT_DIR / "stage3_run50_stricter_constrained_N24_N40_batch32_abqjobpilot_command_validation_summary.json"
...
def validate_line(line: str, row: dict[str, str]) -> dict[str, object]:
    ...
    result: dict[str, object] = {
        ...
        "forbidden_batch_reference": "batch60" in line.lower() or "recovery" in line.lower(),
...
def main() -> int:
    ...
    verdict = "PASS_RUN50_ABQJOBPILOT_COMMAND_FILE_VALID" if not errors else "FAIL_RUN50_ABQJOBPILOT_COMMAND_FILE_INVALID"
    summary = {
        "verdict": verdict,
    ...
    return 0 if verdict == "PASS_RUN50_ABQJOBPILOT_COMMAND_FILE_VALID" else 1
